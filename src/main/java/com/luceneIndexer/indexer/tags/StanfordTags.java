package com.luceneIndexer.indexer.tags;
...
public class StanfordTags {
    ...
    public static final String PREPOSITION_SUB_CONJUNCTION = "IN";
    ...
    public static final String POSSESIVE_ENDING = "POS";
    public static final String PERSONAL_PRONOUN = "PRP";
    public static final String POSSESIVE_PRONOUN = "PRP$";
    ...
    public static final String VERB_GERUND_PRESENT_PARTICIPLE = "VBG";
    public static final String VERB_PAST_PARTICIPLE = "VBN";
    public static final String VERB_NON_3RD_PERSON_SINGULAR_PRESENT = "VBP";
    public static final String VERB_3RD_PERSON_SINGULAR_PRESENT = "VBZ";
